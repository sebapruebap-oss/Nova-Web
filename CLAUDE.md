...
- Las imágenes de productos deben conservar un fondo blanco o gris claro consistente.
...
- Priorizar mobile.
- Revisar desktop después de cada cambio responsive.
- Evitar decoración excesiva.
- No agregar elementos visuales solamente para llenar espacios.
- Mantener el estilo floral, cálido, limpio y profesional de AleAle.
- La propiedad `type` existe actualmente en los productos, pero no participa en la lógica principal de filtrado o renderizado.
- No basar nuevas funcionalidades en `type` sin revisar antes si debe incorporarse realmente al sistema.
...
- En mobile, conservar la navegación táctil.
- No impedir que se vea parcialmente el siguiente producto si el diseño actual lo utiliza como señal visual.
- No cambiar anchos de tarjetas sin probar mobile y desktop.
...
La identidad de AleAle debe conservar:

- estética floral;
- tonos cálidos;
- fondo claro;
- verde utilizado en botones;
- tipografías elegantes;
- espacios limpios;
- aspecto femenino y profesional;
- foco principal en productos.

No sobrecargar la interfaz con:

- flores excesivas;
- sombras fuertes;
- animaciones innecesarias;
- colores ajenos a la marca;
- textos decorativos sin utilidad.
